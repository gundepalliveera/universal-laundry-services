      ...
      <div className="relative w-full bg-white border-t border-ice-200/90 rounded-t-[22px] shadow-[0_-4px_24px_-4px_rgba(15,43,120,0.09)] pointer-events-auto">
        ...
        <div className="mx-auto grid h-[68px] max-w-lg grid-cols-5 items-stretch px-1">
          {navItems.map((item) => {
            ...
            // Target transform: Book is a fixed elevated FAB (-8px); standard items float -14px when active
            ...
            return (
              <button
                ...
                aria-current={!isBook && isActive ? "page" : undefined}
              >
                ...
                <div
                  ...
                  className={cn(
                    ...
                    isBook
                      ? "h-12 w-12 bg-gradient-to-tr from-navy-700 via-navy-600 to-navy-500 text-white ring-[3.5px] ring-white shadow-[0_6px_18px_-3px_rgba(26,83,224,0.45),0_2px_6px_rgba(0,0,0,0.08)]"
                      : "h-11 w-11",
                    !isBook &&
                      (isActive
                ...
                <span
                  className={cn(
                    ...
                    !isBook && isActive ? "opacity-100 scale-100" : "opacity-0 scale-0",
                  )}
                  aria-hidden="true"
                />
              </button>
