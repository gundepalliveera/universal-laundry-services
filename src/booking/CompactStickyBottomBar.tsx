...
export function CompactStickyBottomBar({
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-40 sm:hidden border-t border-gray-200/90 bg-white/98 backdrop-blur-xl px-3.5 pt-3 pb-[calc(12px+env(safe-area-inset-bottom,0px))] shadow-[0_-8px_30px_rgba(0,0,0,0.12)] rounded-t-3xl transition-all">
